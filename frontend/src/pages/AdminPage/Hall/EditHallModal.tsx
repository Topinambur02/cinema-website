...
const EditHallModal = ({ isEditModalOpen, setIsEditModalOpen, selectedHall }: EditHallModalProps): JSX.Element => {
  ...
  const handleEdit = async () => {
    ...
    const updatedHalls = halls.map(h => (h.id === updatedHall.id ? updatedHall : h))
